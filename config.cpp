/*
	(c) 2025 | ZenCarWorkbench | Zenarchist
	...
	class ZenCarWorkbench
	{
		...
		class defs
		{
			...
			class gameScriptModule
			{
				...
				files[] = 
				{ 
					"ZenCarWorkbench/scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				files[] = 
				{ 
					"ZenCarWorkbench/scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				files[] = 
				{ 
					"ZenCarWorkbench/scripts/5_Mission"
				};
			};
		};
	};
...
class CfgVehicles
{
	...
	class Zen_CarWorkbenchKit : ZenKitBoxBase
	{
		...
		hiddenSelectionsTextures[] = { "ZenCarWorkbench\data\textures\workbench_kit_co.paa" };
		// Hologram
		projectionTypename="Zen_CarWorkbench";
	};
	class Zen_CarWorkbench : Inventory_Base
	{
		...
		hiddenSelectionsTextures[] = { "ZenCarWorkbench\data\textures\workbench_co.paa" };
		forceFarBubble = "true";
	...
	class Zen_CarWorkbench_Static : Zen_CarWorkbench
	{
		scope = 2;
		hiddenSelections[] = { "texture" };
		hiddenSelectionsTextures[] = { "ZenCarWorkbench\data\textures\workbench_static_co.paa" };
		class Cargo
		{
			itemsCargoSize[] = { 0,0 };
		};
